            ...
            <nav class="space-y-1.5" x-data="{ openCourses: true, openJobs: true, openResume: false, openPractice: false }">
                ...
                <div>
                    ...
                    <div x-show="openResume" class="pl-6 pt-1 space-y-1">
                        ...
                        <a href="{{ route('student.career.resume') }}" class="flex items-center gap-3 py-2 px-3 rounded-xl text-sm font-semibold text-slate-300 hover:text-white hover:bg-white/10 transition-all group">
                            <svg class="w-4 h-4 text-slate-400 group-hover:text-white shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
