<header x-data="{ profileOpen: false, notifyOpen: false }" class="sticky top-0 z-50 text-white"
    style="background-color: #210f30; border-bottom: 1px solid rgba(241,81,83,0.25); height: 64px;">
    <div class="w-full px-6 h-full flex items-center justify-between gap-4">

        <!-- Left: Logo & Brand Badge -->
        <div class="flex items-center gap-3 shrink-0">
            <button @click="sidebarOpen = !sidebarOpen" class="lg:hidden text-purple-200 hover:text-white p-1">
            ...
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 text-decoration-none">
                <div style="width: 34px; height: 34px; min-width: 34px; min-height: 34px; border-radius: 9px; background: #f15153; color: white; font-weight: 900; font-size: 15px;"
        ...
        <div class="flex-1 max-w-md hidden md:block">
            <div class="relative flex items-center">
                <svg class="w-4 h-4 text-purple-300 absolute left-3.5 pointer-events-none" fill="none"
                ...
                <input type="text" placeholder="Search courses, lessons, users, jobs, payments..."
                    ...
                    class="w-full pl-10 pr-4 py-1.5 rounded-xl text-xs focus:outline-none focus:border-[#f15153] placeholder-purple-300">
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 shrink-0">
            ...
            <div class="relative flex items-center h-full">
                <button @click="notifyOpen = !notifyOpen" style="background: rgba(255,255,255,0.07);"
                    class="p-2 rounded-xl text-purple-200 hover:text-white relative transition-all flex items-center justify-center">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                    </svg>
                    <span style="background: #f15153; color: white; width: 16px; height: 16px; min-width: 16px; min-height: 16px; max-width: 16px; max-height: 16px; border-radius: 50%; font-size: 9px; font-weight: 900; line-height: 1; display: flex; align-items: center; justify-content: center;"
                ...
                <div x-show="notifyOpen" @click.away="notifyOpen = false" x-cloak
                    style="background: #210f30; border: 1px solid rgba(241,81,83,0.25); top: 56px;"
                    class="absolute right-0 w-72 rounded-2xl shadow-2xl py-2 z-50 text-xs text-white">
                    <div class="px-4 py-2 border-b border-purple-800/40 flex justify-between font-bold">
            ...
            <a href="{{ route('home') }}"
                style="background: #1e0d2d; border: 1px solid rgba(255,255,255,0.15); color: white;"
            ...
            <div class="relative flex items-center h-full">
                <button @click="profileOpen = !profileOpen"
                    ...
                    <div style="width: 32px; height: 32px; min-width: 32px; min-height: 32px; max-width: 32px; max-height: 32px; border-radius: 50%; background: #f15153; color: white; font-weight: 900; font-size: 13px; display: inline-flex; align-items: center; justify-content: center; line-height: 1;"
                ...
                <div x-show="profileOpen" @click.away="profileOpen = false" x-cloak
                    style="background: #1e0d2d; border: 1px solid rgba(241,81,83,0.3); top: 56px;"
