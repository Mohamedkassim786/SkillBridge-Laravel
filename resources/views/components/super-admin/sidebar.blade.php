<aside style="background-color: #0B1F3A; border-right: 1px solid rgba(255,255,255,0.08);" class="w-72 p-4 flex flex-col justify-between space-y-6 overflow-y-auto shrink-0">
