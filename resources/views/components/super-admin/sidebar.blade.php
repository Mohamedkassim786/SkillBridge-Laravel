<aside style="background-color: #210f30; border-right: 1px solid rgba(241,81,83,0.25);" 
       ...
       class="w-72 p-4 flex flex-col justify-between space-y-6 overflow-y-auto shrink-0 fixed lg:static top-16 left-0 bottom-0 lg:bottom-auto h-[calc(100vh-4rem)] z-40 lg:z-20 transition-transform duration-300 ease-in-out">
        ...
        <div>
            ...
            <nav class="space-y-1 text-xs font-semibold">
                ...
                <a href="{{ route('super_admin.dashboard') }}"
                    style="{{ $isDashActive ? 'background: #f15153; color: white; border-radius: 12px; font-weight: 800; box-shadow: 0 4px 14px rgba(241,81,83,0.35);' : 'color: #a997be;' }}"
        ...
        <div>
            ...
            <nav class="space-y-1 text-xs font-semibold">
                ...
                @foreach ($platNavs as $nav)
                    ...
                    @endphp
                    <a href="{{ $url }}"
                        style="{{ $isActive ? 'background: #f15153; color: white; border-radius: 12px; font-weight: 800; box-shadow: 0 4px 14px rgba(214,40,40,0.35);' : 'color: #cbd5e1;' }}"
                        class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl hover:bg-white/10 hover:text-white transition-all text-decoration-none">
                        {!! $nav['svg'] !!}
                        <span>{{ $nav['name'] }}</span>
                    </a>
