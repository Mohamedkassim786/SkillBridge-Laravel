<div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4">
    ...
    <div style="background-color: #251237; border: 1px solid rgba(241,81,83,0.25);" class="p-4 rounded-2xl text-white shadow-xl">
    ...
    <div style="background-color: #251237; border: 1px solid rgba(241,81,83,0.25);" class="p-4 rounded-2xl text-white shadow-xl col-span-2 sm:col-span-1">
