<div class="space-y-6" x-data="{}">
    ...
    <div style="background-color: #0B1F3A; border: 1px solid #1e3a5f;" class="rounded-2xl p-6 shadow-xl text-white space-y-4">
        <div class="border-b border-slate-800 pb-3 flex items-center justify-between">
            ...
            <button type="button" wire:click="createManualBackup" style="background-color: #D62828;" class="px-6 py-3 rounded-xl text-white font-black text-xs shadow-lg hover:bg-red-700 transition-all flex items-center gap-2">
