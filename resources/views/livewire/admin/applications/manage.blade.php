<div class="space-y-6" x-data="{ modalOpen: @entangle('showModal') }">
    ...
    <div style="background-color: #251237; border: 1px solid rgba(241,81,83,0.25);" class="rounded-2xl p-5 shadow-xl flex flex-col xl:flex-row xl:items-center justify-between gap-4 text-white">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <div class="relative w-full sm:w-[300px]">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search student, job, company..." style="background: #1e0d2d; border: 1px solid rgba(241,81,83,0.3);" class="w-full pl-9 pr-4 py-2 rounded-xl text-xs font-medium text-white placeholder-slate-400 focus:outline-none focus:border-[#f15153]">
                        ...
                        <tr class="hover:bg-slate-800/60 transition-colors">
                            ...
                            <td class="p-4">
                                <div class="flex items-center gap-3">
                                    <div style="width: 34px; height: 34px; border-radius: 50%; background: #f15153; color: white; font-weight: 800; font-size: 12px;" class="flex items-center justify-center shrink-0">
    ...
    <div x-show="modalOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
        <div @click.away="modalOpen = false" style="background-color: #251237; border: 1px solid rgba(241,81,83,0.25);" class="rounded-3xl shadow-2xl w-full max-w-md overflow-hidden text-white">
            ...
            <form wire:submit.prevent="updateStatus" class="p-6 space-y-4 text-xs font-semibold">
                <div>
                    ...
                    <select wire:model="newStatus" style="background: #1e0d2d; border: 1px solid rgba(241,81,83,0.3); color: white;" class="w-full px-4 py-2.5 rounded-xl focus:outline-none">
                        <option value="submitted" class="text-slate-900">Applied</option>
                        <option value="shortlisted" class="text-slate-900">Shortlisted</option>
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
                    ...
                    <button type="submit" style="background-color: #f15153;" class="px-6 py-2.5 rounded-xl text-white font-black shadow-md">Update Status</button>
                </div>
            </form>
        </div>
    </div>
