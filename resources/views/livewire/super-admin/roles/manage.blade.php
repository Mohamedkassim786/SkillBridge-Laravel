<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button wire:click="$set('showRoleModal', true)" style="background-color: #D62828;" class="px-5 py-2.5 rounded-2xl text-white font-black text-xs shadow-lg hover:bg-rose-700 transition">
            + Create Custom Role
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        @foreach ($roles as $r)
            <div style="background-color: #0B1F3A; border: 1px solid #1e3a5f;" class="rounded-3xl p-6 shadow-xl space-y-4 text-white flex flex-col justify-between">
                <div>
            ...
            <div style="background-color: #0B1F3A; border: 1px solid #1e3a5f;" class="rounded-3xl p-6 shadow-2xl max-w-md w-full text-white space-y-4">
                ...
                <form wire:submit.prevent="createRole" class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="newRoleName" required placeholder="e.g. content_moderator" style="background: #112240; border: 1px solid #1e3a5f; color: white;" class="w-full px-3 py-2.5 rounded-xl text-xs font-mono">
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-2">
                        ...
                        <button type="submit" style="background-color: #D62828;" class="px-5 py-2 rounded-xl text-white font-bold text-xs shadow-md">Create Role</button>
                    </div>
                </form>
            </div>
        </div>
